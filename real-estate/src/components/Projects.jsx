...
const Projects = () => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-fulloverflow-hidden '
      id='Projects'>
      ...
      <p className='text-center text-gray-500 max-w-80 mx-auto'>Creafting Spaces, Building legacies-Explore Our Portpolio</p>
